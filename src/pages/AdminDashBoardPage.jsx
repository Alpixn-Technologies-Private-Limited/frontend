  ...
  return (
    <div className="h-screen flex flex-col dark:bg-gradient-to-r dark:from-[#241f53] dark:via-[#0d0130] dark:to-[#2b1a76]">
      ...
      <div className="flex flex-1 pt-[64px]">
        ...
        <main className="ml-64 max-sm:ml-0 flex-1 overflow-y-auto bg-gray-50 p-4 md:p-6 dark:bg-gradient-to-r dark:from-[#241f53] dark:via-[#0d0130] dark:to-[#2b1a76] max-sm:p-1 max-sm:mx-auto max-sm:w-full">
          <AdminDashBoard />
        </main>
      </div>
