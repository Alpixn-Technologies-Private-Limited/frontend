...
const TeamMembers = () => {
    ...
    const filteredMembers = teamMembersData.filter(member => {
        ...
        const matchesSkills = skillsFilter === "Skills" || member.skills === skillsFilter;
        const matchesStatus = statusFilter === "Status" || member.status === statusFilter;
    ...
    return (
        <div className="min-h-screen flex items-start justify-center bg-gray-50">
            <div className="w-full px-20 bg-white p-8 rounded-xl shadow">
                <div className="mb-6">
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-200">
                    <table className="min-w-full bg-white">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="text-left p-4 text-gray-600 text-sm">Member</th>
                                <th className="text-left p-4 text-gray-600 text-sm">Role</th>
                                <th className="text-left p-4 text-gray-600 text-sm">Skills</th>
                                <th className="text-left p-4 text-gray-600 text-sm">Workload</th>
                                <th className="text-left p-4 text-gray-600 text-sm">Performance</th>
                            ...
                            {filteredMembers.length === 0 ? (
                                ...
                                filteredMembers.map((member, idx) => (
                                    <tr key={idx} className="border-t hover:bg-gray-50 transition">
                                        ...
                                        <td className="p-4 text-blue-600">{member.skills}</td>
                                        <td className="p-4">
                                        ...
                                        <td className="p-4 text-gray-700">{member.performance}</td>
