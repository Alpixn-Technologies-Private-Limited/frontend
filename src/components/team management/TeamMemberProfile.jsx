            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-5">
                    <img
                        ...
                        alt="Sophia Bennett"
                        className="w-20 h-20 ml-10 rounded-full object-cover"
                    />
                    <div>
                ...
                <button className="mt-4 md:mt-0 bg-[#E8EDF5] hover:bg-gray-200 text-gray-800 font-medium px-6 py-2 rounded-lg shadow-sm w-[500px] cursor-pointer">
                    Message
                </button>
            </div>
            <div className="">
              <ul className="flex gap-14 ml-10 mt-4 font-semibold text-gray-700">
                ...
                <li onClick={() => setIsActive("Current Project")} className={`cursor-pointer pb-2 ${isActive==="Current Project" ? "text-black border-b-3" : "text-gray-700"}`}>Current Projects</li>
