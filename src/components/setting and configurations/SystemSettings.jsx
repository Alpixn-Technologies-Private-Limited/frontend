        ...
        <div className="bg-gray-50 min-h-screen p-4 sm:p-6">
            <section className="flex flex-col gap-6">
                ...
                <div className="text-2xl sm:text-3xl font-semibold flex items-center gap-2">
                    General Setting <MdOutlineKeyboardArrowRight className="text-3xl sm:text-4xl" />
                </div>
                ...
                {[
                    ...
                    <div key={idx} className="bg-white border border-gray-300 rounded-lg px-4 py-3 flex flex-col sm:flex-row justify-between text-sm">
                ...
                <div className="text-2xl sm:text-3xl font-semibold flex items-center gap-2 mt-5">
                    User Management <MdOutlineKeyboardArrowRight className="text-3xl sm:text-4xl" />
                </div>
                ...
                <div className="bg-white border border-gray-300 rounded-lg overflow-x-auto">
                    ...
                    {roles.map((role, idx) => (
                        <div key={idx} className="grid grid-cols-3 min-w-[600px] text-sm px-4 py-2 border-b border-gray-100">
                            <span>{role.name}</span>
                            <span>{role.description}</span>
                ...
                <div className="bg-white border border-gray-300 rounded-lg overflow-x-auto">
                    ...
                    {permissionData.map((item, index) => (
                        <div key={index} className="grid grid-cols-4 min-w-[500px] text-sm px-4 py-2 border-b border-gray-100">
                ...
                <div className="bg-white border border-gray-300 rounded-lg">
                    ...
                    {[
                        ...
                        <div key={idx} className="flex justify-between px-4 py-2 text-sm border-t border-gray-200">
                ...
                <div className="bg-white border border-gray-300 rounded-lg overflow-x-auto">
                    ...
                    {integrations.map((integration, idx) => (
                        <div key={idx} className="grid grid-cols-3 min-w-[600px] text-sm px-4 py-2 border-b border-gray-100">
                            <span>{integration.name}</span>
                            <span className={integration.status === "connected" ? "text-green-600 font-medium" : "text-red-500 font-medium"}>
                ...
                {/* API Configuration */}
                <div className="bg-white border border-gray-300 rounded-lg">
                    <div className="px-4 py-3 font-medium">API Configuration</div>
                    {[
                ...
                <div className="bg-white border border-gray-300 rounded-lg overflow-x-auto">
                    ...
                    {webhooks.map((hook, idx) => (
                        <div key={idx} className="grid grid-cols-3 min-w-[600px] text-sm px-4 py-2 border-b border-gray-100">
                            ...
                            <span className={hook.status === "active" ? "text-green-600 font-medium" : "text-red-500 font-medium"}>
