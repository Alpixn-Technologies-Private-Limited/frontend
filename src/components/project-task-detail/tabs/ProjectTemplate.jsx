...
const ProjectTemplate = () => {
  ...
  return (
    <div className="p-4 sm:p-6">
      <h4 className="text-base sm:text-lg font-semibold mb-6">Project Template</h4>
        ...
        {templates.map((template) => (
          ...
          >
            ...
            <div className="bg-white dark:text-black w-full rounded-xl shadow p-4 h-full">
              ...
              />
              <h3 className="text-sm sm:text-base font-medium mb-1">{template.name}</h3>
              <p className="text-xs sm:text-sm text-gray-500 mb-3">{template.description}</p>
              <button className="text-xs sm:text-sm text-black font-semibold bg-gray-200 px-3 py-1 rounded hover:bg-gray-300">
                Select Template
              </button>
            </div>
