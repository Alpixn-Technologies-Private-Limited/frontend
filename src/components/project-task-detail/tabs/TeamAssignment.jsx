...
const TeamAssignment = () => {
  ...
  return (
    <div className="p-4 sm:p-6">
      <h2 className="text-lg sm:text-xl font-semibold mb-4">Team Assignment</h2>
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="h-12 w-full sm:w-100 px-3 py-2 border bg-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
