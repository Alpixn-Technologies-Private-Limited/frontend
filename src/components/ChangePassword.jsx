    ...
    return (
        <div
            className="
                ...
                bg-gradient-to-b from-white to-[#EAE9FF] 
        ...
        >
            ...
            <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-6 sm:p-10 lg:p-16">
                <div className="max-w-md w-full relative">
                    <h1
                        className="
                            ...
                            bg-gradient-to-r from-[#4F46E5] to-[#B700FF] bg-clip-text text-transparent 
                            dark:from-[#FFCC70] dark:to-[#FFD700]
                            mb-4
                        "
                    >
                        Set a New Password
                ...
                <p className="text-center text-xs text-gray-500 dark:text-gray-400 absolute bottom-3">
            ...
            <div
                className="
                    hidden md:flex justify-center items-center w-full md:w-1/2 p-6 
