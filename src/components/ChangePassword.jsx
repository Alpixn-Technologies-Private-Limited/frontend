                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 pr-10 focus:outline-none focus:ring focus:border-blue-400 text-sm sm:text-base placeholder-gray-400"
                                />
                                <button
                                    type="button"
