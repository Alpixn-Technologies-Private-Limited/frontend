            ...
            <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-6">
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <div className="hidden lg:flex items-center bg-gray-100 rounded-md p-1 ml-2">
                    ...
                    <button className="flex items-center justify-center gap-1 bg-gradient-to-r from-purple-700 to-yellow-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:opacity-90 transition">
                        <FiPlus size={16} />
                        Add Project
                    </button>
                </div>
